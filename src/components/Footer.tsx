      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-20">
          <div className="md:col-span-1">
            <h2 className="text-2xl font-headline tracking-tighter text-primary mb-6 uppercase">
              CECILIA SOUSA
            </h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Especialista em Brow Lamination, Lash Lifting e Design Estratégico em São Caetano do Sul. Foco em naturalidade, técnica e saúde dos fios.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm font-body">
              ...
              <li className="opacity-40 italic">Garanta seu horário antecipado, bb!</li>
            </ul>
          </div>

          <div>
            <h3 className="font-headline uppercase tracking-widest text-xs mb-6 opacity-60">Siga no Instagram</h3>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-primary/5 gap-4">
          <p className="text-[10px] uppercase tracking-[0.2em] opacity-30">
            © 2026 CECILIA SOUSA BEAUTY. BELEZA NATURAL COM ELEGÂNCIA.
          </p>
